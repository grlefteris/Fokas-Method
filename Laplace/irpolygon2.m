function [z_side z_corner ang m h]=irpolygon2(Npol,Ncol,rot_z,axis_x,axis_y)
%==================Polygon's Details=======================================
s=linspace(-1,1,Ncol);
%==========================================================================
%==========================================================================
...
ang=zeros(Npol,1);
for j=1:Npol-1
    ang(j)=atan2(real(z_corner(j+1)-z_corner(j)),...
        imag(z_corner(j+1)-z_corner(j)));
end
    ang(Npol)=atan2(real(z_corner(1)-z_corner(Npol)),...
        imag(z_corner(1)-z_corner(Npol)));
%==========================================================================    
